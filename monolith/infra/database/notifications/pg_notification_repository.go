...
func (r *PgNotificationRepository) Save(notification *notifications.Notification) (*notifications.Notification, error) {
	...
	err := r.pool.QueryRow(ctx,
		"INSERT INTO notifications (type, recipient, message, status) VALUES ($1, $2, $3, $4) RETURNING id, created_at",
		notification.Type, notification.Recipient, notification.Message, string(notification.Status),
	).Scan(&id, &createdAt)
