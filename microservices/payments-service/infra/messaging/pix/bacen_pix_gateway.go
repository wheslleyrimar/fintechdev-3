...
func (g *BacenPixGateway) NotifyCreation(payment *domain.PixPayment) {
...
func (g *BacenPixGateway) Authorize(payment *domain.PixPayment) error {
...
func (g *BacenPixGateway) Settle(payment *domain.PixPayment) error {
